                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-info mt-2">
                            <div class="card-header">
                                ...
                                {!! Form::open([ 'route' => ['admin.brand.update',$data_list->id], 'id' => 'supplierForm', 'method' => 'post']) !!}
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="code">@lang('form.email')<span class="text-danger">*</span></label>
                                        {!! Form::text('code', $data_list->code, [ 'class' => 'form-control', 'data-validation-required-message' => 'This field is required']) !!}
