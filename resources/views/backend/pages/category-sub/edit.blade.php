                ...
                <div class="row justify-content-md-center">
                    <div class="col-lg-12">
                        <div class="card card-info mt-2">
                            ...
                            {!! Form::open([ 'route' => ['admin.sub_category.update',$sub_category->id ],'name'=>'supplierForm' ,'id' => 'supplierForm', 'method' => 'post']) !!}
                            @csrf
                            <div class="card-body">
                                <div class="form-row">
                                        ...
                                        @else
                                            ...
                                            <select class="form-control" id="category_id" name="category_id">
                                                ...
                                                @foreach($categories as $data_row)
                                                    <option value="{{ $data_row->id}}" @if($data_row->id == $sub_category->category_id): selected @else ' ' @endif>
                                        ...
                                        @else
                                            ...
                                            <select class="form-control" id="brand_id" name="brand_id">
                                                ...
                                                @foreach($brands as $data_row)
                                                    <option value="{{ $data_row->id}}" @if($data_row->id == $sub_category->brand_id): selected @else ' ' @endif>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            ...
                                            <option value="active" {{( $sub_category->status == "active" )? "selected": " "}}>Active</option>
                                            <option value="inactive" {{( $sub_category->status == "inactive" )? "selected": " "}}>Inactive</option>
