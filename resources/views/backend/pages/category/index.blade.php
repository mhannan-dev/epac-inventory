                        ...
                        <div class="card mt-2">
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    <a href="{{ route('admin.category.create') }}" class="btn btn-outline-info"><i class="fas fa-plus"></i> &nbsp;Add {{$title}}</a>
                                </div>
                                        ...
                                        @foreach ($all_supplier as $key => $list)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.category.edit', $list->id ) }}" class="badge badge-info">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="{!! route('admin.category.delete', $list->id) !!}"
                                                                        method="post">
                                                                        {{ csrf_field() }}
