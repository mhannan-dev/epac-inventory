                        ...
                        <div class="card mt-2">
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    <a href="{{ route('admin.units.create') }}" class="btn btn-outline-info"><i class="fas fa-plus"></i> &nbsp;Add {{$title}}</a>
                                </div>
                                    ...
                                    @if(count($all_supplier))
                                        @foreach ($all_supplier as $key => $list)
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $count_unit = App\Models\Product::where('unit_id',$list->id)->count();
                                                    @endphp
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.units.edit', $list->id ) }}" class="badge badge-info">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="{!! route('admin.units.delete', $list->id) !!}"
                                                                        method="post">
                                                                        {{ csrf_field() }}
